...
export function ContentTable({ rows, startIndex, disabled, onAction }: {
  rows: ContentRow[]; startIndex: number; disabled: boolean; onAction: (row: ContentRow, action: ContentAction) => void;
}) {
